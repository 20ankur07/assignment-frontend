...
export function ContactSection() {
  ...
  return (
    <section
      ref={ref}
      className="flex h-screen w-screen shrink-0 snap-start items-center px-4 pt-32 md:px-12 md:pt-24 lg:px-16"
    >
        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4 md:space-y-8">
              <a
                href="mailto:hello@flowstudio.com"
              ...
              >
                ...
                <p className="text-base text-foreground md:text-2xl">New Delhi, IN</p>
              </div>
        ...
        >
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-foreground/15 backdrop-blur-md">
                <span className="font-sans text-base font-bold text-foreground">F</span>
              </div>
              <span className="font-sans text-base font-semibold tracking-tight text-foreground">FlowStudio</span>
            </div>

            <p className="font-mono text-xs text-foreground/60">© 2025 FlowStudio. All rights reserved.</p>

            <div className="flex gap-4">
              <a href="#" className="font-mono text-xs text-foreground/60 transition-colors hover:text-foreground">
                Privacy
              </a>
              <a href="#" className="font-mono text-xs text-foreground/60 transition-colors hover:text-foreground">
                Terms
